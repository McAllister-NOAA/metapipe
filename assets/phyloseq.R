...
for (i in c("Phylum")) {
  ...
  pdf(file=paste0('barplot_readcount_allsamples_alltaxa_',i,'_legend.pdf', sep = ""), width = 22, height = 6)
...
if (controlFlag == TRUE || filteredLowQualSamples == TRUE) {
  for (i in c("Phylum", "Class", "Order", "Family", "Genus", "Species")) {
    ...
    bar_plot_legend <- get_legend(bar_plot)
    bar_plot <- bar_plot + theme(legend.position='none')
    pdf(file=paste0('barplot_readcount_filtsamples_alltaxa_',i,'_legend.pdf', sep = ""), width = 22, height = 6)
    print(as_ggplot(bar_plot_legend))
    dev.off()
...
for (i in c("Phylum", "Class", "Order", "Family", "Genus", "Species")) {
  ...
  bar_plot_legend <- get_legend(bar_plot)
  bar_plot <- bar_plot + theme(legend.position='none')
  pdf(file=paste0('barplot_relabund_filtsamples_alltaxa_',i,'_legend.pdf', sep = ""), width = 22, height = 6)
  print(as_ggplot(bar_plot_legend))
  dev.off()
...
if (replicateFlag == TRUE) {
  for (i in c("Phylum", "Class", "Order", "Family", "Genus", "Species")) {
    ...
    bar_plot_legend <- get_legend(bar_plot)
    bar_plot <- bar_plot + theme(legend.position='none')
    pdf(file=paste0('barplot_relabund_replicateGroupedSamples_alltaxa_',i,'_legend.pdf', sep = ""), width = 22, height = 6)
    print(as_ggplot(bar_plot_legend))
    dev.off()
...
if (sitelabelFlag == TRUE) {
  for (i in c("Phylum", "Class", "Order", "Family", "Genus", "Species")) {
    ...
    bar_plot_legend <- get_legend(bar_plot)
    bar_plot <- bar_plot + theme(legend.position='none')
    pdf(file=paste0('barplot_relabund_siteGroupedSamples_alltaxa_',i,'_legend.pdf', sep = ""), width = 22, height = 6)
    print(as_ggplot(bar_plot_legend))
    dev.off()
